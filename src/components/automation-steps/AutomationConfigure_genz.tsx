                  ...
                  {loadingMedia ? (
                    ...
                    <div className="grid grid-cols-3 gap-2 max-h-48 overflow-y-auto">
                      {posts.map(post => {
                        ...
                        return (
                          <div key={post.id} onClick={() => toggleMediaSelection(post.id)} className={`relative cursor-pointer aspect-square rounded-xl overflow-hidden border-2 transition-all ${isSelected ? 'border-purple-600' : 'border-transparent hover:border-purple-200'}`}>
