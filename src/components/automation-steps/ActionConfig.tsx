...
export default function ActionConfig({ triggerType, actions, onActionsChange, onSave, saving, readOnly }: ActionConfigProps) {
  ...
  return (
    <div className="space-y-5 md:space-y-6 pb-24 w-full">
      ...
      <div className="fixed md:absolute bottom-10 md:bottom-0 left-0 right-0 px-5 md:px-12 bg-gradient-to-t from-white via-white/95 to-transparent pt-16 pb-8 z-20 pointer-events-none flex justify-center">
        {readOnly ? (
